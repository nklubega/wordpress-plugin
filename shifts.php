      ...
      <form method="POST" id = "add">
        ...
        <div class="input">
          <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" name = "name" placeholder = "Caregiver name..">
          </div>

          <div class="form-group col-md-12">
            <label>Shift description</label>
            <textarea name="desc" id=""  rows="3" style = "width: 100%;"></textarea>
          </div>
...
<div class = "frame" style = "width : 95%; margin auto; border-radius: 20px;">
  <div class = "card-header" style = "margin-top : 20px; border-top-left-radius: 20px; border-top-right-radius: 20px;">
      <h4 style = "margin-top : 10px;"><b>Caregivers' Shifts</b></h4>
  </div>
        ...
        <table class="table table-striped" border = "0" style = "overflow-x: hidden;">
            ...
            ?>
                ...
                <tr>
                  ...
                  <td class = "action">
                      <button type = "button" class = "btn btn-success" data-toggle = "modal" data-target = "#<?php echo $shift->Id."update"; ?>" data-backdrop = "true">Update</button>
                  </td>

                  <td class = "action">
                      <button type = "button" class = "btn btn-danger" data-toggle = "modal" data-target = "#<?php echo $shift->Id."delete"; ?>" data-backdrop = "true">Delete</button>
                  </td>
                </tr>
